...
```
npm create cloudflare@latest -- --template=cloudflare/templates/round-sun-edb8
```

A live public deployment of this template is available at [https://round-sun-edb8.templates.workers.dev](https://round-sun-edb8.templates.workers.dev)
